...
class HarringtonSmoClassifier(Classifier):
    ...
    def smoPK(self, dataMatIn, classLabels, C, toler, maxIter):    #full Platt SMO
        oS = self.optStructK(mat(dataMatIn),mat(classLabels).transpose(),C,toler)
        iter = 0
